    ...
    var strItems = function (items) {
        for (var innerHTML = '', i = 0, l = items.length; i < l; ++i) {
            innerHTML +=
                ...
                items[i].imageUrl +
                '\')"><a href="' + items[i].detailUrl + '" target="_blank">' + items[i].name + '</a></div> \
        <div class="fashionade--content"> \
          <dl> \
        <dt class="fashionade--brand"><a href="' + items[i].detailUrl + '" target="_blank">' + items[i].brand + '</a></dt> \
        <dd class="fashionade--name"><a href="' + items[i].detailUrl + '" target="_blank">' + items[i].name + '</a></dd> \
          </dl> \
        </div> \
      </li>'
        }
